h5. to jumpstart this puzzles git repo into a local repo (of %{color:blue}your choice%).
...
# _reset changes out of cache (optional)_, e.g. @git reset src/puzzles.java@
...
# _pull from remote git repo (optional)_, e.g. @git pull@
